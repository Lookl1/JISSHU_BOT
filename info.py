...
URL = "https://jisshu-bot-57dm.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jisshu-bot-57dm.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jisshu-bot-57dm.onrender.com/".format(FQDN)
else:
    URL = "https://jisshu-bot-57dm.onrender.com/".format(FQDN)
